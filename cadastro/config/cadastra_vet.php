        ...
        $foto= $_FILES["foto"];
         ...
         if($result=mysqli_query($mysqli,$sqlVCD))
         {
             ...
             if($qtdLinhas>0)
             {
                ...
                $result = mysqli_query($mysqli, "INSERT INTO veterinarios (NOME_COMPLETO, SENHA, CPF, DATA_DE_NASCIMENTO, EMAIL, TELEFONE, UF, CEP, CIDADE, RUA, NUM_CASA, CRMV, UNIVERSIDADE, IMG_PERFIL) 
                VALUES ('$nome $sobrenome','$senha','$cpf','$data_nasc','$email','$telefone','$uf','$cep','$cidade','$rua','$numero','$crmv','$universidade','$novoNomeDoArquivo.$extensao')");
