...
<header>
        ...
        <div class="headerlogin">
            <?php if ($logado): ?>
                ...
                include("C:/xampp/htdocs/cepet/usuario/config/conexao.php");  $sql ="SELECT NOME_COMPLETO FROM VETERINARIOS WHERE ID_VETERINARIO = '$id'";
                $result = mysqli_query($mysqli, $sql);
                $nome = mysqli_fetch_assoc($result);
                $nome['NOME_COMPLETO'];
                echo $nome['NOME_COMPLETO']; ?> !</span>
                <!------------------------------------------------------------------------------------------------------->
        ...
        $sql="SELECT IMG_PERFIL FROM veterinarios WHERE ID_VETERINARIO= '$id' ";
        $result= mysqli_query($mysqli, $sql);
        $img_perfil = mysqli_fetch_assoc($result);
        $img_perfil['IMG_PERFIL'];
        echo"<a href='/cepet/veterinario/perfilvet.php'><img class='pessoa' src='/cepet/veterinario/img/img_perfil/$img_perfil[IMG_PERFIL]'>";}
        ?>
        <!----------------------------------------------------------------------------------------------------->
    </header>
