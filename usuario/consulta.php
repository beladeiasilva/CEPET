    ...
    <form action="/cepet/usuario/config/perfilvet/info_vet.php" method="GET">
        ...
        <section class="veterinarios-container">
            ...
            <?php echo"<img src='/cepet/veterinario/img/img_perfil/$dados[IMG_PERFIL]'>";?>
                ...
                <a href="<?php echo "perfilvet.php?ID_VETERINARIO=$dados[ID_VETERINARIO]";?>"><button>Ver Perfil</button></a>


            </div>
            <div class="veterinario-card">
                <img src="/cepet/veterinario/img/img_perfil/images.jpeg" alt="Dra. Maria Oliveira">
            ...
            <div class="veterinario-card">
                <img src="/cepet/veterinario/img/img_perfil/vet1.jpeg" alt="Dr. Pedro Santos">
